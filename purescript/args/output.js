...
(function($PS) {
  ...
  var runY = function (setup) {
      return function (v) {
          return function __do() {
              var value = Node_Yargs.runYargs(Data_Semigroup.append(Node_Yargs_Setup.semigroupYargsSetup)(setup)(v.setup))();
              var v1 = Control_Monad_Except.runExcept(v.read(value));
              ...
              throw new Error("Failed pattern match at Node.Yargs.Applicative (line 53, column 3 - line 55, column 27): " + [ v1.constructor.name ]);
          };
      };
  };
  var readOneOrMany = function (f) {
      return function (key) {
          return function (value) {
              return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Foreign_Index.readProp(key)(value))(function (value$prime) {
                  return Control_Alt.alt(Control_Monad_Except_Trans.altExceptT(Data_List_Types.semigroupNonEmptyList)(Data_Identity.monadIdentity))(Data_Functor.map(Control_Monad_Except_Trans.functorExceptT(Data_Identity.functorIdentity))(Control_Applicative.pure(Control_Applicative.applicativeArray))(f(value$prime)))(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Foreign.readArray(value$prime))(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Except_Trans.applicativeExceptT(Data_Identity.monadIdentity))(f)));
              });
          };
      };
  };
...
(function($PS) {
  ...
  var app = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Main (line 19, column 1 - line 19, column 46): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var main = function __do() {
      var args = Node_Process.argv();
      Effect_Console.log(Data_Show.show(Data_Show.showArray(Data_Show.showString))(args))();
